...
.rolling-content-02 {
    animation: rollInY-03 ease-in-out both;
    animation-timeline: view();
...
.rolling-content-04 {
    animation: rollInX ease-in-out both;
    animation-timeline: view();
    animation-range: entry 0% entry 150%;
}

.rolling-content-05 {
    animation: rollInY ease-in-out both;
    animation-timeline: view();
...
@media (max-width: 768px) {
    .rolling-line-01 {
        display: block;
        animation: rollInY-02 0.6s ease-in-out both;
        animation-timeline: view();
    }
}
